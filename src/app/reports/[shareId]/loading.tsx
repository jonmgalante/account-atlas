    ...
    <SectionFrame className="py-12">
      <Container className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="grid gap-6">
          ...
          <div className="rounded-[1.75rem] border border-strong/80 bg-panel/82 px-3 py-3 shadow-panel">
          ...
          <div className="grid gap-4">
            {Array.from({ length: 4 }).map((_, index) => (
              <Card key={index} className="border-strong/80 bg-card/78">
        ...
        <Card className="hidden border-strong/80 bg-panel/84 shadow-panel xl:block">
          <CardHeader className="space-y-4">
            <div className="h-4 w-28 animate-pulse rounded-full bg-muted" />
